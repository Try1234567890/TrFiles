...
import me.tr.trfiles.file.configuration.implementations.properties.PropertiesConfiguration;
...
public class MemoryPropertiesConfiguration extends MemoryConfiguration {
    ...
    private final @NotNull JavaPropsMapper javaPropsMapper;
    ...
    public @NotNull JavaPropsMapper getJavaPropsMapper() {
