...
import me.tr.trfiles.registries.Registry;
...
import me.tr.trfiles.file.configuration.size.Size;
import me.tr.trfiles.file.configuration.size.SizeUnit;
...
public abstract class FileConfiguration implements Section {
    ...
    private File file;
    private Size size;
    private final @NotNull ConfigEntry entry;

    protected FileConfiguration(@NotNull ConfigEntry entry, File file) {
