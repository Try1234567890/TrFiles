...
import me.tr.trfiles.file.configuration.implementations.UnknownImplementationException;
...
public abstract class MemoryConfiguration extends MemorySection implements Config {
    ...
    private final @NotNull MemoryEntry entry;

    protected MemoryConfiguration(@NotNull MemoryEntry entry) {
    ...
    public @NotNull MemoryEntry getEntry() {
        return entry;
    }
