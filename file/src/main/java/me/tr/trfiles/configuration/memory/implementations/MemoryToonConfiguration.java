...
import me.tr.trfiles.configuration.implementations.toon.JToonSer;
...
public class MemoryToonConfiguration extends MemoryConfiguration {
    ...
    private final JToonSer jToonSer;
    ...
    public MemoryToonConfiguration(JToonSer jToonSer) {
        super(ENTRY);
