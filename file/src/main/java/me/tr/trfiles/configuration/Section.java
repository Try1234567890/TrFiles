...
public interface Section {
     ...
     */
    boolean isSectionArray(String path);
     ...
     */
    boolean isObjectArray(String path);
     ...
     */
    boolean isStringArray(String path);
     ...
     */
    boolean isIntegerArray(String path);
     ...
     */
    boolean isNumberArray(String path);
     ...
     */
    boolean isBooleanArray(String path);
     ...
     */
    boolean isDoubleArray(String path);
     ...
     */
    boolean isFloatArray(String path);
     ...
     */
    boolean isLongArray(String path);
     ...
     */
    boolean isCharacterArray(String path);
     ...
     */
    boolean isShortArray(String path);
     ...
     */
    boolean isBigIntegerArray(String path);
     ...
     */
    boolean isBigDecimalArray(String path);
    ...
    boolean isPrimitiveIntegerArray(String path);
    ...
    boolean isPrimitiveBooleanArray(String path);
    ...
    boolean isPrimitiveDoubleArray(String path);
    ...
    boolean isPrimitiveFloatArray(String path);
    ...
    boolean isPrimitiveLongArray(String path);
    ...
    boolean isPrimitiveByteArray(String path);
    ...
    boolean isPrimitiveCharacterArray(String path);
    ...
    boolean isPrimitiveShortArray(String path);
     ...
     *
     * @param path path relative to this section.
     * @return {@link DataType} describing the stored value.
     */
